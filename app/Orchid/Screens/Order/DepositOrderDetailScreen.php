    ...
    public function layout(): iterable
    {
        return [
            Layout::legend('order', [
                ...
                Sight::make('status', 'Status')->render(fn (DepositOrder $o) => $o->status->label()),
                Sight::make('callback_status', 'Callback Status')->render(fn (DepositOrder $o) => $o->callback_status?->label() ?? '-'),
                Sight::make('fund_status', 'Fund Status')->render(fn (DepositOrder $o) => $o->fund_status?->label() ?? '-'),
